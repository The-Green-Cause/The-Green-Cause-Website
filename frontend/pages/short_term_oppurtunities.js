        ...
        <div className="max-w-5xl mx-auto mt-12 px-6 space-y-10">
          {[
            ...
            },
            {
             ...
             <div
                key={i}
                className="bg-teal-600 p-6 rounded-xl shadow-md text-white flex flex-col justify-between"
            >   
            <div>
            ...
            <a
                ...
                className="inline-flex items-center justify-center bg-white text-teal-700 px-4 py-2 mt-4 rounded-lg font-semibold shadow-md hover:bg-gray-100 transition"
            >
                Get Involved
            </a>
    </div>
